...
namespace UI
{
    public partial class Trangchinh : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public Trangchinh()
        {
            InitializeComponent();
        ...
        private void banhang_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            this.Hide();
            BanHangDE bh = new BanHangDE();
            bh.ShowDialog();
        }
